...
router.put('/:id/estado', verifyToken, requireRol(['vendedor', 'superadmin']), updateVentaEstado);
router.delete('/:id', verifyToken, requireRol(['vendedor', 'superadmin']), deleteVenta);
