                                ...
                                <div key={prod.id} className="card-premium flex flex-col gap-3 group animate-fade-in">
                                    ...
                                    <div className="space-y-2">
                                        <h4 
                                            ...
                                            className="font-bold text-slate-800 text-[10px] leading-tight line-clamp-2 min-h-[1.5rem] hover:text-primary-500 transition-colors cursor-pointer uppercase tracking-tight"
                                        >
                                            {prod.nombre}
                                        </h4>
                                        <div className="flex justify-between items-center">
