...
export const PublicCatalog: React.FC = () => {
    ...
    return (
        <div className="min-h-screen bg-slate-50 font-sans pb-24 selection:bg-primary-200 selection:text-primary-900">
                    ...
                    {filteredProducts.map(prod => (
                        <div key={prod.id} className="bg-white rounded-3xl p-4 border border-slate-100 flex flex-col items-center text-center shadow-sm hover:shadow-md transition-all group overflow-hidden">
                            ...
                            <div className="flex flex-col items-center mb-3">
                                <p className="font-black text-primary-500 text-lg leading-none">${Number(prod.precioSugerido).toLocaleString()}</p>
                                <span className={`text-[9px] font-black uppercase tracking-widest mt-1.5 px-2 py-0.5 rounded-full ${prod.stock > 0 ? 'bg-primary-50 text-primary-600' : 'bg-red-50 text-red-500'}`}>
            ...
            {isLoginModalOpen && (
                <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-md z-[200] flex items-center justify-center p-4">
                    <div className="bg-white rounded-[2.5rem] p-8 max-sm w-full shadow-2xl text-center relative animate-fade-in">
                ...
                {selectedProduct && (
                    <div className="fixed inset-0 bg-slate-900/80 backdrop-blur-md z-[400] flex items-center justify-center p-4">
                        ...
                        >
                            ...
                            <div className="overflow-y-auto overflow-x-hidden premium-scrollbar px-4 my-6 pb-4">
